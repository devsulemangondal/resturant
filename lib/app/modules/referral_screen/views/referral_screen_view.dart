    ...
    return GetX(
      ...
      builder: (controller) {
        return Scaffold(
            ...
            //backgroundColor: themeChange.isDarkTheme() ? AppThemeData.black : AppThemeData.white,
            body: controller.isLoading.value
                ? Constant.loader()
                : Padding(
                    padding: EdgeInsets.fromLTRB(
                        16, 16, 16, MediaQuery.of(context).padding.bottom + 14),
                    child: Column(
                      children: [
                                ...
                                child: RoundShapeButton(
                                    ...
                                    onTap: () async {
                                      await SharePlus.instance.share(
                                        ShareParams(
                                            text: "Referral_Code".trParams({
                                          "referralCode": controller
                                              .referralModel.value.referralCode
                                              .toString()
                                        })
                                            // 'Go4Food \n\n🍽️ Order your favorite meals with Go4Food! \n\nUse my referral code ${controller.referralModel.value.referralCode} when you sign up and get delicious rewards on your first order. \n\nDon’t miss out – join now!'
                                            //     .tr
                                            ),
                                      );
                                    },
