...
import 'package:restaurant/dependency/google_auto_complete_textfield/model/place_details.dart';
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            if (widget.isCrossBtnShown)
              IconButton(
                icon: Icon(isCrossBtn ? Icons.close : Icons.location_on),
                onPressed: isCrossBtn ? _clearField : _openPlacePicker,
              ),
          ],
        ),
      ),
        ...
        builder: (_) => PlacePicker(
          ...
          onPlacePicked: (result) async {
            ...
            if (placemarks.isNotEmpty) {
              ...
              final fullAddress = "${place.street}, ${place.name}, ${place.subLocality}, ${place.locality}, ${place.administrativeArea}, ${place.postalCode}, ${place.country}";

              widget.textEditingController.text = fullAddress;

              if (widget.getPlaceDetailWithLatLng != null) {
                widget.getPlaceDetailWithLatLng!(
                  Prediction(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return InkWell(
                        ...
                        child: widget.itemBuilder != null
                            ...
                            : Container(padding: const EdgeInsets.all(10), child: Text(alPredictions[index].description!)),
                      );
                    },
                  )),
                ),
