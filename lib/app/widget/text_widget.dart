...
class TitleTextCustom extends StatelessWidget {
  ...
  const TitleTextCustom({super.key, this.isUnderLine = false, required this.title, this.islineThrough = false, this.maxLine, this.fontSize = 12, this.fontFamily = FontFamily.bold, this.color});
