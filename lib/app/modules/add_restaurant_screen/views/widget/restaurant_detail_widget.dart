...
class RestaurantDetailWidget extends StatefulWidget {
  const RestaurantDetailWidget({super.key});
...
class _RestaurantDetailWidgetState extends State<RestaurantDetailWidget>
  ...
  late final AddRestaurantScreenController controller;
  FocusNode restaurantNameFocusNode = FocusNode();
  FocusNode restaurantAddressFocusNode = FocusNode();

  @override
  void initState() {
    super.initState();
    controller = Get.find<AddRestaurantScreenController>();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildRestaurantNameField(themeChange),
                _buildRestaurantAddressField(themeChange),
                _buildCuisineDropdown(themeChange),
                spaceH(height: 12),
                if ((Constant.platFormFeeSettingModel?.packagingFeeActive) ==
                    true)
                  Obx(
                    () => PackagingFeeCard(
      ...
      bottomNavigationBar: Padding(
        ...
        child: Obx(() => GradientRoundShapeButton(
  ...
  Widget _buildRestaurantNameField(DarkThemeProvider themeChange) {
    return Padding(
          ...
          TextFormField(
            ...
            validator: (value) {
              if (value == null || value.isEmpty) {
                return "Restaurant name is required".tr;
              }
              return null;
            },
          ),
  ...
  Widget _buildRestaurantAddressField(DarkThemeProvider themeChange) {
    return Padding(
      padding: const EdgeInsets.only(top: 20),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          InkWell(
            ...
            child: IgnorePointer(
              child: TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return "Restaurant address is required".tr;
                  }
                  return null;
                },
              ),
  ...
  Widget _buildCuisineDropdown(DarkThemeProvider themeChange) {
    return Padding(
      padding: const EdgeInsets.only(top: 20),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          DropdownButtonFormField<CuisineModel>(
            isExpanded: true,
            onChanged: (value) {
              controller.selectedCuisine.value = value!;
            },
            initialValue: controller.cuisineList
        ...
        try {
          ...
          try {
            ...
            controller.locationLatLng.value =
                LocationLatLng(latitude: 19.228825, longitude: 72.854118);
            controller.restaurantAddressController.value.text =
                "${placeMark.name}, ${placeMark.subLocality}, ${placeMark.locality}, ${placeMark.administrativeArea}, ${placeMark.postalCode}, ${placeMark.country}";
          } catch (e, stack) {
            // log("Error getting default location: $e",
            //     stackTrace: stack);
          }
          ShowToastDialog.closeLoader();
        }
  ...
  void _handleNextButton(BuildContext context) {
    ...
    restaurantNameFocusNode.unfocus();
    restaurantAddressFocusNode.unfocus();
